...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <!-- table idea from https://www.tutorialrepublic.com/codelab.php?topic=bootstrap&file=user-management-data-table -->
                                            ...
                                            <td class="candidate-list-favourite-time text-right">
                                                <div class="btn-group" role="group">
                                                    <form action="UserEdit.jsp">
                                                        <button class="btn btn-info btn-sm me-1" data-toggle="tooltip" title="Edit" type="submit"
